...
export default function ItemBlock({ healthPoints, image = '/images/noImage.png', name, description, location, region, drops, quote, role, weight, category, attack, defence, effect, hpCost, fpCost }: ITrowData) {
    return (
        <div className="gap-2 min-[1000px]:flex">
            <div className="w-full">
                ...
                {hpCost && (
                    <div className="flex gap-2 pt-2">
                        <h1>HP COST : {hpCost}</h1>
                    </div>
                )}
                {fpCost && (
                    <div className="flex gap-2 pt-2">
                        <h1>FP COST : {fpCost}</h1>
                    </div>
                )}
            </div>
